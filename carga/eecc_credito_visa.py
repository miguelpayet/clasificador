...
class EECCCreditoVisa(EECC):
    ...
    def add_seccion_linea(self):
        ...
        seccion.add_texto_fijo('idcuenta', self.cuenta)
        seccion.add_texto_fecha('fecha_consumo', 0, 5, self.fecha_inicio, self.fecha_fin)
        seccion.add_texto_fecha('fecha_proceso', 9, 5, self.fecha_inicio, self.fecha_fin)
